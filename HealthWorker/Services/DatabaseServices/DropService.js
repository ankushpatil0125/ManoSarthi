...
const DropService = {
  dropTables: async () => {
    dr1 = await DropService.dropMedicalQuestionsTable();
    console.log("dr1: ", dr1);

    dr2 = await DropService.dropMedicalHistoryAnswersTable();
    console.log("dr2: ", dr2);

    dr3 = await DropService.dropSurveyQuestionTable();
    console.log("dr3: ", dr3);

    dr4 = await DropService.dropPatientDetailsTable();
    console.log("dr4: ", dr4);

    dr5 = await DropService.dropSurveyQuestionAnswerTable();
    console.log("dr5: ", dr5);

    dr6 = await DropService.dropAabhaIdInfoTable();
    console.log("dr6: ", dr6);
