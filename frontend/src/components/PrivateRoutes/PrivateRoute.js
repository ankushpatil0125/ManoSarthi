...
const PrivateRoute = ({children, type}) =>{
    ...
    else if(JWT && localStorage.getItem("ROLE") ==="[ROLE_DOCTOR]" && type==="pendingpatient")return children;
    ...
    else if(JWT && localStorage.getItem("ROLE") ==="[ROLE_ADMIN]" && type==="delete-doctor-supervisor")return children;
    ...
    else if(JWT && localStorage.getItem("ROLE") ==="[ROLE_DOCTOR]" && type==="patient-details")return children;
    else if(JWT && localStorage.getItem("ROLE") ==="[ROLE_DOCTOR]" && type==="add-prescription")return children;
