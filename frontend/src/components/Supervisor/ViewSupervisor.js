  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (!district && !subdistrictcode) {
        ...
        response = await AdminService.getAllSupervisors(currentPage);
      } else if (district && !subdistrictcode) {
        console.log("inside  distruct");
        response = await AdminService.getAllDistrictSupervisors(
          district,
          currentPage
        );
      } else if (subdistrictcode) {
        console.log("insise subdistrict change");
        response = await AdminService.getAllSubDistrictSupervisors(
          subdistrictcode
        );
