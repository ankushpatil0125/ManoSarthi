...
//           <button className="bg-[#6467c0] hover:bg-[#636481] text-white font-bold py-2 px-4 rounded">
//             Add Prescription
//           </button>
//         </Link>
//       </div>
        ...
        return (
          <div>
            <div className="flex justify-between">
              ...
              <Profile firstname={firstname} lastname={lastname} village={village}/>
            ...
            <p className="text-1xl font-bold  flex text-[#6467c0]">Patient Name : {firstname} {lastname}</p>
          <p className="text-1xl  font-bold   flex text-[#6467c0]">Patient Village : {village}</p>
          <p className="text-1xl  font-bold flex text-[#6467c0]">Patient Gender : {gender}</p>
          </div> */}
    ...
    <section className="py-8 flex-1">
                <div className="container mx-auto">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <h4 className="">Survey Registration</h4>
                    </div>
                    {followUpDetails.map((followup, follow_index) => (
                      <div
                        className="bg-blue-50 rounded-lg p-4 my-2"
